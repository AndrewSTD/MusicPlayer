        ...
        new GUI() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (button1.equals(source)) {
                    ...
                    if (listIterator.hasNext()) {
                        label.setText("Now playing " + listIterator.next().toString());
                    } else {
                        label.setText("No song available, reached to the end of the list");
                        forward = false;
                    }
                    ...
                    if (listIterator.hasPrevious()) {
                        label.setText("Now playing " + listIterator.previous().toString());
                    } else {
                        label.setText("Previous doesn't exist");
                        forward = false;
                    }
                    ...
                    if (forward) {
                        if (listIterator.hasPrevious()) {
                            ...
                            label.setText("we are at the start of the list");
                        }
                    } else {
                        if (listIterator.hasNext()) {
                            label.setText("now playing " + listIterator.next().toString());
                            ...
                            label.setText("we have reached to the end of list");
                        }
                    }
                    ...
                    label.setText("Playlist complete");
                    quit = true;
                }
            ...
            switch (action){
                ...
                case 1:
                    ...
                    if(listIterator.hasNext()){
                        ...
                        System.out.println("No song available, you've reached to the end of the list");
                        forward = false;
                    }
                    break;
                case 2:
                ...
                case 3:
                    if(forward){
                        ...
                        if(listIterator.hasNext()){
                            ...
                            System.out.println("You have reached to the end of list");
                        }
                    }
                    break;
